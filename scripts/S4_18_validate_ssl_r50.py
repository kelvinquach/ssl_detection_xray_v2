#!/usr/bin/env python3
"""S4.18 — Faster R-CNN R50-FPN SSL official execution-path preflight."""
...
EXPECTED_CONFIG_SHA256 = {
    "1pct": "8d5d54b45c58835d825ad4e3bc2f7dcb10d9364ba28edf0a3871e824edfdd454",
    "5pct": "fe738a87a7743b712d49fe05932d1d2a85f842e76f392e390936f905d264ad22",
    "10pct": "8dcfd50cc14345ddf3e6386dac3b376e2afe7d1114a5512b0964f03b412a9462",
    "20pct": "c84b535aaeece55d871ee90c0329dd894739c6b9a444fe2f56a36403f2b13040",
}
...
def main() -> int:
    ...
    for budget, relative_path in CONFIG_PATHS.items():
        ...
        local_checks = {
            ...
            "backbone_is_resnet50":
                detector.backbone.type == "ResNet"
                and detector.backbone.depth == 50,
            ...
            "imagenet_backbone_only":
                ...
                == "Pretrained"
                and detector.backbone.init_cfg["checkpoint"]
            ...
            "r50_norm_eval_true":
                detector.backbone.norm_eval is True,
    ...
    checks["all_4_r50_budget_configs_resolve_pass"] = all(
    ...
    print("\n===== OFFICIAL R50 1PCT RUNTIME PATH =====")
    ...
    checks["runtime_student_backbone_is_resnet"] = (
        type(model.student.backbone).__name__ == "ResNet"
    )
    checks["runtime_teacher_backbone_is_resnet"] = (
        type(model.teacher.backbone).__name__ == "ResNet"
    )
    ...
    report = {
        "schema_version": "1.0",
        "stage": "S4.18",
        "scope": "ssl_r50_execution_path_preflight",
        ...
        "deferred_preofficial_requirements": {
            "ssl_entrypoint_manifest": (
                ...
                "official training; not owned by S4.18."
            ),
            "ssl_swin_preflight": (
                "Owned by S4.19."
            ),
    ...
    if failed_checks:
        print("S4_18_SSL_R50_PREFLIGHT=FAIL")
        return 1

    print("S4_18_SSL_R50_PREFLIGHT=PASS")
    return 0
