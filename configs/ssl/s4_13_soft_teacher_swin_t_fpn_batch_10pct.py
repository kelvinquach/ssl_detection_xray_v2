...
_base_ = './s4_12_soft_teacher_swin_t_fpn_loss_weight.py'
...
labeled_dataset = dict(
    type='CocoDataset',
    ann_file='/workspace/ssod/data/coco/instances_labeled_10pct.json',
...
unlabeled_dataset = dict(
    type='CocoDataset',
    ann_file='/workspace/ssod/data/coco/instances_unlabeled_10pct.json',
    data_prefix=dict(img='/workspace/ssod/data/mmdet_images'),
    metainfo=dict(classes=classes),
    filter_cfg=dict(filter_empty_gt=False),
    test_mode=False,
